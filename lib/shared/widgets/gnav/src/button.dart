// ignore_for_file: curly_braces_in_flow_control_structures, deprecated_member_use, avoid_unnecessary_containers
// ignore_for_file: library_private_types_in_public_api, use_super_parameters, no_leading_underscores_for_local_identifiers,
// curly_braces_in_flow_control_structures, deprecated_member_use, avoid_unnecessary_containers, unnecessary_library_name
              ...
              child: Builder(
                builder: (_) {
                  if (widget.style == GnavStyle.google) {
                    // Wrap the icon so we can overlay the trailing badge
                    // directly on top of it. The badge is visible whether
                    // the tab is expanded (active) or not.
                    final Widget iconWithBadge = widget.trailing != null
                        ? Stack(
